...
def parse_and_merge_results(input_directory="data/outputs", final_csv_path="outputs/openai4_llm_responses.csv"):
    print(f"[INFO] Scanning '{input_directory}' for downloaded batch result files...")
    
    # Locate all JSONL files ending with '_results.jsonl'
    search_pattern = os.path.join(input_directory, "openai4_*_results.jsonl")
